...
try:
    from example_2.model_development_example_2 import compute_window_weights, precompute_features
    from example_2.prelude_example_2 import (
    ...
    from model_development_example_2 import compute_window_weights, precompute_features
    from prelude_example_2 import (
        backtest_dynamic_dca,
        check_strategy_submission_ready,
        load_data,
        parse_window_dates,
...
def create_performance_metrics_summary(
    ...
    output_path = os.path.join(output_dir, "metrics_summary_example_2.svg")
    plt.savefig(output_path, format="svg", bbox_inches="tight")
    plt.close()
    logging.info(f"✓ Saved: {output_path}")
...
def export_metrics_json(
    ...
    output_path = os.path.join(output_dir, "metrics_example_2.json")
...
def main():
    ...
    logging.info("Starting Bitcoin DCA Strategy Analysis - Example 2")
    btc_df = load_data()
